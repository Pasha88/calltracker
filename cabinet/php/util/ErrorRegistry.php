...
class ErrorRegistry
{
    ...
    public $USER_ERR_UPDATE_CUSTOMER_ORDER_STATUS;
    ...
    public function __construct()
    {
        ...
        $this->USER_ERR_UPDATE_CUSTOMER_ORDER_STATUS = new ErrCode('USER_ERR_UPDATE_CUSTOMER_ORDER', "Ошибка обновления платежа клиента");
