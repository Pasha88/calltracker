...
function RegisterCtrl($rootScope, $scope, $state, $http, $uibModal, authenticate, BASE_PATH, notify, util, localStorageService) {
    $scope.working = false;
    $scope.wrong = false;
    $scope.error = null;
    ...
    $scope.checkForm = function() {
        return $scope.agree === true && !util.isEmpty($scope.email) && !util.isEmpty($scope.pwd);
    };
    ...
    $scope.register = function () {
        ...
        if($scope.agree !== true) {
            notify({
                message: "Необходимо нажать галочку \"Согласие\"",
                classes: 'allostat-alert-danger',
                position: 'center',
                duration: '5000'
            });
